...
// //         {/* <button 
// //           onClick={() => navigate("/")} 
// //           className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-6 py-3 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300 font-semibold hover:shadow-xl hover:shadow-red-500/25 animate-in slide-in-from-right delay-500"
// //         >
// //           Logout
// //         </button> */}
...
// //             {/* Centered Modal Box */}
// //             <motion.div
// //               className="relative bg-white rounded-3xl shadow-2xl p-8 w-80 text-center z-10"
...
// //                 <li className="px-4 py-3 rounded-xl bg-gray-100 hover:bg-orange-100 cursor-pointer transition font-medium">
// //                   View Profile
// //                 </li>
// //                 <li className="px-4 py-3 rounded-xl bg-gray-100 hover:bg-orange-100 cursor-pointer transition font-medium">
// //                   Check Booking
...
// //                   Get My Booking
// //                 </li>
// //                 <li className="px-4 py-3 rounded-xl bg-red-100 text-red-600 hover:bg-red-200 cursor-pointer transition font-medium">
// //                   Logout
// //                 </li>
// //               </ul>
...
// //               <button
// //                 onClick={() => setOpen(false)}
// //                 className="mt-6 px-5 py-2 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold hover:opacity-90 transition"
// //               >
// //                 Close
// //               </button>
// //             </motion.div>
...
//                     <motion.button
//                       onClick={() => setOpen(false)}
//                       className="w-full px-6 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 
//                                text-white font-semibold hover:from-orange-600 hover:to-orange-700 
//                                transition-all duration-300 transform hover:scale-105 hover:shadow-lg 
//                                active:scale-95 ring-2 ring-transparent hover:ring-orange-200"
//                       initial={{ y: 20, opacity: 0 }}
//                       animate={{ y: 0, opacity: 1 }}
